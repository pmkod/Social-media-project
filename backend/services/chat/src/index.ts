...
import { discussionsRoutes } from "./features/discussions/routes";
import { messagesRoutes } from "./features/messages/routes";

const app = new OpenAPIHono();

app.use("*", setAuthenticatedUser);
app.openapiRoutes(discussionsRoutes);
app.openapiRoutes(messagesRoutes);
...
if (Configurations.environment.nodeEnv === Environments.development) {
	app.doc("/openapi", {
		...
		info: {
			version: "1.0.0",
			title: "Social Media Chat Service API",
		},
	});
