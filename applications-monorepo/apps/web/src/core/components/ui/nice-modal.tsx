 ...
 */
export type NiceModalHandler<Props = Record<string, unknown>> =
	NiceModalState & {
		/**
...
const ALREADY_MOUNTED = {} as Record<string, any>;
...
const InnerContextProvider = ({ children }: PropsWithChildren) => {
